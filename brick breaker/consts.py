...
PADDLE_LIVES    = 3
#Paddle color
PADDLE_COLOR = introcs.RGB(0,0,255)
...
BRICK_COLUMNS  = 8
BRICK_COLOR = introcs.RGB(255,0,255)
H_BRICK_COLOR = introcs.RGB(0,255,0)


###ball CONSTANTS
CIRCLE_DIAMETER = 20
RADIUS = CIRCLE_DIAMETER/2
CIRCLE_COLOR = introcs.RGB(0,0,0)
BALL_SPEED = 3
SPEED_MAX_X = 8
SPEED_MAX_Y = 12
SPEED_MIN_X = 1.5
